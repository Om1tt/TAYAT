...
bool Tree::CanBeAdded(type_data type1, type_data type2) {
	if ((type1 == typeInt || type1 == typeBool) &&
		(type2 == typeInt || type2 == typeBool)) {
		return true;
	}
	return false;
}
